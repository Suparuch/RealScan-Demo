...
public class RealScanTest extends javax.swing.JFrame {
    ...
    public RealScanTest() {
        ...
        drawCanvas.setBounds(1, 1, 401, 401);
    ...
    private void initComponents() {
            ...
            .addGroup(ioTabLayout.createSequentialGroup()
                .addGroup(ioTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ioTabLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(ioTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lcd, javax.swing.GroupLayout.PREFERRED_SIZE, 84, Short.MAX_VALUE)
                            .addComponent(fingerLED, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(ioTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(ioTabLayout.createSequentialGroup()
                                .addGap(12, 12, 12)
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(overlayLineColor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(rollDirectionOpt, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(rollTimeoutVal, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(selMinFingerCount, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(selCaptDir, 0, 150, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        callbackOptTabLayout.setVerticalGroup(
            callbackOptTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, callbackOptTabLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(callbackOptTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void takeCaptureBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_takeCaptureBtnActionPerformed
        ...
        result = RealScan_JNI.RS_TakeCurrentImageData(deviceHandle, 10000, imageInfo);
        ...
        saveSeqCechkTargetImages(imageInfo.pbyImgBuf, imageInfo.imageWidth, imageInfo.imageHeight);
    ...
    private void selectModeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectModeActionPerformed
        ...
        for(int i=0; i<16; i++)
        {
            if(selectMode.getSelectedIndex() == i)
                nCaptureMode = captureModes[i];
        }
    ...
    private void selMinFingerCountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selMinFingerCountActionPerformed
        RealScan_JNI.RS_SetMinimumFinger(deviceHandle, selMinFingerCount.getSelectedIndex());
    ...
    Runnable DoAutoCapture = new Runnable() {
        ...
        public void run() {
            ...
            if(result == RealScan_JNI.RS_SUCCESS) {
                result = RealScan_JNI.RS_TakeImageData(deviceHandle, 10000, imageInfo);
            }
    ...
    public void segmentImageResult(RealScan_JNI.RSImageInfo imageInfo) {
        if (selectResult.getSelectedIndex() == 2) // segment
        {
            ...
            switch (captureMode_result[0]) {
                ...
                case RealScan_JNI.RS_CAPTURE_FLAT_TWO_FINGERS:
                case RealScan_JNI.RS_CAPTURE_FLAT_TWO_FINGERS_EX:
                    slapType = RealScan_JNI.RS_SLAP_TWO_FINGER;
                    break;
                case RealScan_JNI.RS_CAPTURE_FLAT_LEFT_FOUR_FINGERS:
    ...
    public void saveSeqCechkTargetImages(byte[] imgByte, int imageWidth, int imageHeight)
    {
        if(nSlapType < RealScan_JNI.RS_SLAP_ONE_FINGER)
        {
            boolean bIsOverlapped = false;
            int nOverlappedIndex = nNumOfTargets;
            for(int i=0; i< nNumOfTargets; i++)
            {
                if(nSeqCheckTargetSlapTypes[i] == nSlapType)
                {
                    bIsOverlapped = true;
                    nOverlappedIndex = i;
                    break;
            ...
            else
            {
                ...
                nSeqCheckTargetSlapTypes[nNumOfTargets] = nSlapType;
                ...
                nNumOfTargets++;
                nNumOfTargetFingers += nFingerCount;
            }
        }
    }
        ...
        String[] pFingerMsg = {
            ...
            else
            {
                ...
                for(int i=0; i< numOfSlaps; i++)
                {
                    ...
                    seqRetVal = RealScan_JNI.RS_SequenceCheck(1, fingerImageInfo, bSeqCheckTargetImages[i], nSeqCheckTargetWidths[i], nSeqCheckTargetHeights[i], nSeqCheckTargetSlapTypes[i], seqCheckResult, nSecuLev);
                    
                    if(seqRetVal > 0)
                    {
                        String seqRetMsg = "This finger is the " + pFingerMsg[seqRetVal] + " finger";
